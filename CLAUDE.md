...
- **Phase P1 — Nền tảng kế toán:** account_codes (đã đồng bộ 347 TK theo file Excel ngày 2026-06-05), accounting_periods, journal_entries/lines, AccountingService (post/reverse/getBalance), auto-posting trong InvoiceService/StockService/CashVoucherService, AccountCodeController/AccountingPeriodController/JournalEntryController ✅ (2026-05-28)
