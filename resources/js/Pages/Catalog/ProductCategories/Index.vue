  ...
  <AppLayout>
    <div class="space-y-5">
      <div class="flex items-center justify-between">
        ...
        <Link :href="route('catalog.product-categories.create')"
      ...
      <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <table class="w-full text-sm">
          <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
              <th class="text-left px-5 py-3 font-semibold text-gray-600">Tên danh mục</th>
              <th class="text-left px-5 py-3 font-semibold text-gray-600">Danh mục cha</th>
    ...
    <Modal :show="deleteTarget !== null" @close="deleteTarget = null">
      ...
      <p class="text-gray-600">Bạn có chắc muốn xóa danh mục <strong>{{ deleteTarget?.name }}</strong> không?</p>
      <template #footer>
...
const confirmDelete = (category) => { deleteTarget.value = category; };

const doDelete = () => {
  router.delete(route('catalog.product-categories.destroy', deleteTarget.value.id), {
