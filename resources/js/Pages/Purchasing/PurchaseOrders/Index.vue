  ...
  <AppLayout>
    <div class="space-y-5">
      <div class="flex items-center justify-between">
        ...
        <Link
          v-if="can('purchasing.create')"
          :href="route('purchasing.purchase-orders.create')"
        ...
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-gray-100">
            <tr v-for="po in orders.data" :key="po.id" class="hover:bg-gray-50">
              ...
              <td class="px-5 py-3 text-gray-600">{{ po.creator }}</td>
              <td class="px-5 py-3">
            ...
            <tr v-if="!orders.data?.length">
              <td colspan="8" class="px-5 py-10 text-center text-gray-400">Chưa có đơn mua hàng nào</td>
            </tr>
          </tbody>
        </table>
      </div>
