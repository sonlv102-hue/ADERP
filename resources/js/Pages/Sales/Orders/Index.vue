        ...
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-gray-100">
            <tr v-for="o in orders.data" :key="o.id" class="hover:bg-gray-50">
              ...
              <td class="px-5 py-3 text-gray-600">{{ o.order_date }}</td>
              <td class="px-5 py-3 text-gray-600">{{ o.expected_delivery ?? '—' }}</td>
            ...
            <tr v-if="!orders.data?.length">
              <td colspan="8" class="px-5 py-10 text-center text-gray-400">Chưa có đơn hàng nào</td>
            </tr>
          </tbody>
        </table>
      </div>
