    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-xl border border-gray-200">
        ...
        <div v-if="activeTab === 'expenses'" class="p-5 space-y-4">
          ...
          <!-- Nút thêm chi phí mới (mở trang riêng) -->
          <div v-if="can('projects.manage')" class="flex items-center justify-between">
            <p class="text-sm text-gray-500">Chi phí nhân công, máy, vận chuyển, và các chi phí phát sinh trực tiếp cho dự án.</p>
            <Link :href="route('projects.projects.expenses.create', project.id)"
              class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap">
