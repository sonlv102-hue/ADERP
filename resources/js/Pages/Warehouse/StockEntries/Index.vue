    ...
    <div class="space-y-5">
      ...
      <div class="flex gap-3 flex-wrap">
        <input v-model="search" @input="doSearch" type="text"
          placeholder="Tìm phiếu nhập, kho, nhà cung cấp, mã chứng từ..."
...
const props = defineProps({ entries: Object, filters: Object, statuses: Array });
...
function doSearch() {
  ...
  searchTimer = setTimeout(() => {
    router.get(route('warehouse.stock-entries.index'), {
