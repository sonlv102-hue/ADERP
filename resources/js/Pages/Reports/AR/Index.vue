    ...
    <div class="space-y-5">
      ...
      <div class="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-0.5">Hóa đơn bán + công nợ đầu kỳ — tổng tiền, đã thu, còn lại theo hạn thanh toán</p>
        </div>
        ...
        <table class="w-full text-sm">
          <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th class="text-right px-4 py-3 font-semibold text-gray-600">Đã thu (TM)</th>
              <th class="text-right px-4 py-3 font-semibold text-blue-600">Ứng trước đối trừ</th>
          ...
          <tbody class="divide-y divide-gray-100">
            <tr v-for="row in rows.data" :key="row.source_type + '-' + row.id" class="hover:bg-gray-50">
              <td class="px-4 py-3">
                <template v-if="row.source_type === 'invoice'">
