...
const URL_TITLES = {
  ...
  '/purchasing/quote-comparisons':   'So sánh báo giá',
  '/accounting/invoices':            'Hóa đơn',
  '/accounting/journal-entries':    'Phiếu KT',
  '/accounting/prepaid-expenses':   'CP trả trước',
  '/accounting/bank-accounts':      'TK ngân hàng',
  '/accounting/payment-terms':      'Điều khoản TT',
  '/accounting/account-codes':      'Hệ thống TK',
  '/accounting/accounting-periods': 'Kỳ kế toán',
  ...
  '/reports/ar/detail':              'SoCT công nợ thu',
  '/reports/ap/aging':               'Công nợ phải trả',
  '/reports/ap/detail':              'SoCT công nợ trả',
  ...
  '/reports/company-cashflow':        'Dòng tiền TK công ty',
