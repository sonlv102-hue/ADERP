...
class BankTransactionsExport extends BaseListExport
{
    ...
    protected function columns(): array
    {
        return [
            ...
            ['key' => 'counterpart_bank',    'header' => 'NH đối ứng',    'width' => 20, 'type' => 'text'],
            ['key' => 'counterpart_account', 'header' => 'TK đối ứng',   'width' => 18, 'type' => 'text'],
            ['key' => 'counterpart_name',    'header' => 'Tên đối ứng',  'width' => 24, 'type' => 'text'],
    ...
    protected function buildRows(): array
    {
        ...
        return BankTransaction::with(['bankAccount'])
            ...
            ->map(fn ($tx) => [
                ...
                'counterpart_bank'    => trim((string) $tx->counterpart_bank),
